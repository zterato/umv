...
<a href="recibo.php"><button class="btn btn-danger">Fechar</button></a>
</center><br><br>
	<div class="container">
		<div class="row">
			<div class="col-md-12 cadproduto" style="border=1px solid black;" id="print">
				<center><h4>MG JOIAS RIO DE JANEIRO</h4>
				ESTRADA MUNI. ANTÔNIO ALÉM BERGARA, N10<br>
				MAGÉ - RIO DE JANEIRO - RJ<br>
				Telefones: (21) 98200-6409<br>
				...
				<?php 
		                    try{
								...
								ORDER BY nota.id_nota DESC limit 1;";
